...
Nov 2025 - present \\
London, UK \\
Part of a very large team of ML engineers.
\begin{bulletlist}
    \item Performance tuning of markdown and price optimisation pipelines.
\end{bulletlist}
\textbf{Skills:} Kubeflow, Python, Markdown Optimization, Price Optimization, Gurobi
...
\begin{bulletlist}
    ...
    \item Built infrastructure to streamline model integration and deployment.
