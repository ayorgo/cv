...
London, UK
\begin{bulletlist}
    \item Led end-to-end development of cloud-based machine learning pipelines
    ...
    \item As the company's first and only MLE, mediated the communication between data scientists and software engineers
