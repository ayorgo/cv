...
\section*{SKILLS}
MLOps, Recommender Systems, Machine Learning, Python, PyTorch, Bash, SQL, Information Retrieval, Search Engines, Statistics, Linux, Docker, Amazon Web Services (AWS), Terraform, Elasticsearch
