...
London, UK
\begin{bulletlist}
    \item Established a set of cloud-based machine learning pipelines taking the weight off of software engineers' shoulders and allowing data scientists to iterate faster
...
\begin{bulletlist}
    ...
    \item Established continuous development and deployment pipelines
